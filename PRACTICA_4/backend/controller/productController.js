...
export const crearProducto=async(req,res)=>{
    try{
        ...
        const newProducto=await Producto.crearNuevoProducto(nombreProducto,marca,precio,talla);
...
export const ActualizarNuevoProducto=async(req,res)=>{
    try{
        ...
        await Producto.ActualizarProducto(id,req.body.nombreProducto,req.body.marca,req.body.precio,req.body.talla);
